...
class CSLRTopo( Topo ):
		...
		# Add links between hosts and switches
                ...
                self.addLink( h1, s0 ) # h1-eth0 <-> s1-eth1
                self.addLink( h2, s1 ) # h2-eth0 <-> s2-eth1
                self.addLink( h3, s1 ) # h3-eth0 <-> s3-eth1
                self.addLink( h4, s2 ) # h4-eth0 <-> s4-eth1
                self.addLink( h5, s2 ) # h5-eth0 <-> s5-eth1
                self.addLink( h6, s3 ) # h6-eth0 <-> s6-eth1
                self.addLink( h7, s3 ) # h7-eth0 <-> s7-eth1
